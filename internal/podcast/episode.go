...
func UpdateEpisode(dbClient *database.Client, pod *protos.Podcast, epi *protos.Episode) error {
...
func FindEpisode(dbClient *database.Client, epiID *protos.ObjectID) (*protos.Episode, error) {
...
func FindEpisodeByNumber(dbClient *database.Client, podID *protos.ObjectID, num int) (*protos.Episode, error) {
	var epi protos.Episode
	filter := bson.D{
...
func FindLatestEpisode(dbClient *database.Client, podID *protos.ObjectID) (*protos.Episode, error) {
	var epi protos.Episode
